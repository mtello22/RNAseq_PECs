...
```{r}
genes_interest <- unique(exp_percent$external_gene_name)
#the one below allows me to analyse particular genes, I can add as much as I can (pamietaj o zmianie matriksu jak jest np. wiecej niz 10)
genes_interest <- c("ARC","ALG9")

#the command below is a command which I can use for picking the first 10 or 20 genes to see the fold change (I can change genes_interest[] matrix 1:20 or something like that )

ggplot(exp_percent[external_gene_name %in% genes_interest[1:10]], 
